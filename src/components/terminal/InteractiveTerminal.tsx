  ...
  return (
    <div className="w-full h-full bg-black border border-green-400/30 rounded-lg overflow-hidden font-mono text-xs sm:text-sm">
      ...
      <div className="flex flex-col h-full">
        <div
          ref={terminalRef}
          className="flex-1 overflow-y-auto overflow-x-hidden p-1.5 sm:p-2 lg:p-3 space-y-0.5 scrollbar-hide min-h-0"
          style={{
            scrollbarWidth: 'none', /* Firefox */
            msOverflowStyle: 'none', /* Internet Explorer 10+ */
            maxHeight: 'calc(100% - 120px)' // Reserve space for input area
          }}
