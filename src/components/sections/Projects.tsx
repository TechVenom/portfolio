      ...
      <div className="container-custom section-padding relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-xl text-gray-400 max-w-2xl mx-auto px-4">
            A collection of my innovative contributions in AI, Cybersecurity, and Web Development.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-gradient-to-b from-primary-500/30 to-accent-500/30 border-dashed border-l border-gray-600"></div>
            ...
            {sortedProjects.map((project, index) => (
              ...
              >
                ...
                <div className={`glass-effect rounded-xl p-6 shadow-lg ${index % 2 === 0 ? 'md:mr-auto md:pr-8 md:w-5/12 ml-8 md:ml-0' : 'md:ml-auto md:pl-8 md:w-5/12 mr-8 md:mr-0 md:text-right'}`}>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-primary-400 font-medium">{project.period}</span>
                      </div>
                    </div>
                  ...
                  {/* Action Buttons */}
                  <div className={`flex space-x-4 ${index % 2 === 0 ? 'justify-start' : 'md:justify-end'}`}>
                    <button
                      onClick={() => {
